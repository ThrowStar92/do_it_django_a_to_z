...
class TestView(TestCase):
    ...
    def test_comment_form(self, new_comment_div=None):
    ...
    def test_comment_update(self):
        ...
        content_testarea = update_comment_form.find('textarea', id= 'id_content')
        self.assertIn(self.comment_001.content, content_testarea.text)
